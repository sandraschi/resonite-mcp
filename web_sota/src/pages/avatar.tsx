			...
			<div className="flex flex-col md:flex-row md:items-center justify-between gap-6 p-1">
				<div className="flex items-center gap-4">
					<div className="relative">
						<div className="absolute -inset-1 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000" />
			...
			<div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
				...
				<div className="lg:col-span-4 space-y-6">
					<div className="group relative">
						<div className="absolute -inset-0.5 bg-gradient-to-b from-purple-500/20 to-transparent rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition duration-700" />
						<div className="relative glass-card overflow-hidden border-white/10 rounded-3xl">
								...
								{avatarInfo?.thumbnail ? (
									...
									<div className="w-full h-full flex flex-col items-center justify-center gap-4 text-slate-800">
										...
										<div className="flex flex-col items-center">
											...
											<span className="text-xs font-mono opacity-20 mt-1">
												NO_SIG_DETECTED
											</span>
										</div>
									</div>
							...
							<div className="p-6 space-y-2 border-t border-white/[0.05] bg-white/[0.02]">
								<h3 className="text-xl font-bold text-white tracking-tight">
									{avatarInfo?.name || "Sandra Schipal"}
								</h3>
								<div className="flex items-center gap-2">
									...
									<p className="text-[10px] text-slate-500 font-mono tracking-tighter uppercase">
										{avatarInfo?.id || "RES_XRAY_ALPHA_990"}
									</p>
								</div>
							</div>
						...
						<div className="space-y-5">
							<div className="space-y-2">
								<div className="flex justify-between items-end">
									...
									<span className="text-xs font-mono text-white">
										42.1K <span className="text-[10px] opacity-30">tris</span>
									</span>
								</div>
							...
							<div className="space-y-2">
								<div className="flex justify-between items-end">
									...
									<span className="text-xs font-mono text-white">
										8 <span className="text-[10px] opacity-30">/ 16</span>
									</span>
								</div>
								<div className="h-1.5 bg-black/40 rounded-full overflow-hidden border border-white/[0.05]">
							...
							<div className="space-y-2">
								<div className="flex justify-between items-end">
									...
									<span className="text-xs font-mono text-white">
										124 <span className="text-[10px] opacity-30">MB</span>
									</span>
								</div>
								<div className="h-1.5 bg-black/40 rounded-full overflow-hidden border border-white/[0.05]">
					...
					<div className="glass-card p-1 rounded-3xl border-white/10 bg-white/[0.01]">
						<div className="p-6">
								...
								<div className="flex items-center gap-3">
									...
									<div>
										...
										<p className="text-xs text-slate-500">
											Real-time neural driver parameters
										</p>
									</div>
								</div>
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
								{Object.entries(avatarInfo?.parameters || {}).map(
									([key, value]) => (
										<div
											key={key}
											className={cn(
										...
										>
											<div className="absolute top-0 right-0 p-3 opacity-0 group-hover/item:opacity-100 transition-opacity">
												<div className="w-1.5 h-1.5 rounded-full bg-purple-500/50 blur-[2px]" />
											</div>

											<div className="flex items-center justify-between mb-4">
												<div className="flex flex-col">
													<span className="text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-0.5">
														{key}
													</span>
							...
							<div className="grid grid-cols-1 gap-2">
								<button
									onClick={() =>
										setParamMutation.mutate({
											param: "EyeTrack",
											value: !avatarInfo?.parameters?.EyeTrack,
										})
									}
								...
								>
									<span className="flex items-center justify-center gap-2">
										Neural Gaze{" "}
										{avatarInfo?.parameters?.EyeTrack ? "Lock" : "Unlock"}
								...
								<button
									onClick={() =>
										setParamMutation.mutate({
											param: "NeuralSync",
											value: !avatarInfo?.parameters?.NeuralSync,
										})
									}
									className="w-full bg-white/[0.03] hover:bg-white/[0.08] border border-white/10 rounded-2xl py-3 text-[11px] font-bold uppercase tracking-widest text-slate-300 transition-all hover:translate-x-1 group/btn"
								>
									<span className="flex items-center justify-center gap-2">
										Focus{" "}
										{avatarInfo?.parameters?.NeuralSync
											? "Release"
											: "Persistence"}
						...
						<div className="flex flex-col sm:flex-row items-center justify-between gap-6 p-2">
							<div className="flex gap-5 items-center">
								...
								<div className="space-y-1">
									<h4 className="font-black text-white text-xl tracking-tight uppercase">
										Kinetic State
									</h4>
									<div className="flex items-center gap-2">
