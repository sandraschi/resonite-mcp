		...
		<Card className="border-border/50 bg-card/30 backdrop-blur-md glass overflow-hidden border-t-indigo-500/30">
			<CardHeader className="bg-gradient-to-b from-indigo-500/[0.05] to-transparent border-b border-border/50">
				<div className="flex items-center gap-3">
					...
					<div>
						...
						<CardDescription className="text-[10px] text-muted-foreground uppercase font-bold tracking-tighter opacity-70">
			...
			<CardContent className="p-6 space-y-6">
				<div className="space-y-2">
					...
					<select
						className="w-full bg-muted/30 border border-border/50 text-foreground rounded-xl h-11 px-4 text-xs font-bold focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500/40 transition-all appearance-none cursor-pointer"
		...
		<div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
				...
				<Card className="border-border/50 bg-card/30 backdrop-blur-md glass overflow-hidden border-t-indigo-500/30">
					<CardHeader className="bg-gradient-to-b from-indigo-500/[0.05] to-transparent border-b border-border/50">
						<div className="flex items-center gap-3">
							...
							<div>
								...
								<CardDescription className="text-[10px] text-muted-foreground uppercase font-bold tracking-tighter opacity-70">
									Multiplex Connection Parameters
								</CardDescription>
							</div>
						</div>
					</CardHeader>
					<CardContent className="p-6 space-y-6">
							...
							<div className="grid gap-2">
								...
								<div className="relative group">
									...
									<div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2">
										...
										<span className="text-[8px] font-black text-emerald-500/70 tracking-tighter uppercase">
											ACTIVE
										</span>
									</div>
								</div>
								<p className="text-[10px] text-muted-foreground opacity-50 px-1">
									Ensure this matches your RESONITE_WEBAPP_PORT setting.
								</p>
							</div>
						...
						<div className="pt-2 flex gap-3">
							<Button
								variant="outline"
								className="flex-1 border-border/50 bg-muted/20 hover:bg-muted text-xs font-bold uppercase tracking-widest rounded-xl h-11 glass transition-all"
							>
				...
				<Card className="border-border/50 bg-card/30 backdrop-blur-md glass overflow-hidden border-t-amber-500/30">
					...
					<CardContent className="p-6 space-y-6">
						...
						<div className="pt-2">
							<Button
								variant="outline"
								className="w-full border-border/50 bg-muted/20 hover:bg-muted text-xs font-bold uppercase tracking-widest rounded-xl h-11 glass transition-all border-dashed border-2 text-amber-400/80 hover:text-amber-400 hover:border-amber-500/40"
							>
								<Save className="h-3.5 w-3.5 mr-2" />
								Apply Adv. Manifest
							</Button>
			...
			<div className="p-5 rounded-2xl border border-border/50 bg-muted/20 flex flex-col md:flex-row items-center gap-6">
				...
				<div className="flex-1 text-center md:text-left">
					<h4 className="text-sm font-black uppercase tracking-widest text-foreground mb-1">
						Integrity Lock Active
					</h4>
					<p className="text-[11px] text-muted-foreground leading-relaxed">
						Some parameters are direct-mapped from your host environment
						configuration. Changes to these values require a full neural restart
						to successfully synchronize with the Resonite substrate.
					</p>
				</div>
