        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-400">Discover and manage connected Resonite-MCP extensions.</p>
                </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <Card className="border-indigo-500/20 bg-indigo-500/10 hover:border-indigo-500/40 transition-colors">
                    ...
                    <CardContent>
                        <p className="text-sm text-slate-400">Automated spawning tool for ProtoFlux components.</p>
                        <div className="mt-4 flex gap-2">
                            <Button variant="secondary" size="sm" className="bg-white/5 text-slate-200 hover:bg-white/10 border-0">Launch</Button>
                        </div>
                    </CardContent>
                </Card>
            </div>
