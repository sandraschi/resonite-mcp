				...
				<div className="flex items-center gap-3">
					...
					<div>
						...
						<p className="text-sm text-slate-500">
							Query platform metadata and live session registry
						</p>
					</div>
				</div>
			</div>
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
				<div className="glass-card p-4 space-y-2">
					...
					<p className="text-xs text-slate-400">
						Version:{" "}
						<span className="text-white">{platformData?.version || "N/A"}</span>
					</p>
					<p className="text-xs text-slate-400">
						Build:{" "}
						<span className="text-white font-mono">
							{platformData?.build || "N/A"}
						</span>
					</p>
				</div>
				<div className="glass-card p-4 space-y-2">
					...
					<p className="text-xs text-slate-400">
						Authenticated: <span className="text-emerald-400">Yes</span>
					</p>
					<p className="text-xs text-slate-500 italic">
						Connected via local Resonite session
					</p>
				</div>
				<div className="glass-card p-4 space-y-2">
					...
					<p className="text-xs text-slate-400">
						Total sessions:{" "}
						<span className="text-white">{sessionData?.length || 0}</span>
					</p>
					<button
					...
					<table className="w-full text-left text-sm">
						<thead>
							<tr className="border-b border-white/[0.05]">
								<th className="pb-3 text-slate-500 font-semibold px-2">
									Session Name
								</th>
								...
								<th className="pb-3 text-slate-500 font-semibold px-2 text-right">
									Universe
								</th>
								<th className="pb-3 text-slate-500 font-semibold px-2" />
							</tr>
								...
								filteredSessions
									...
									.map((session: ResoniteSession) => (
										...
										>
											...
											<td className="py-3 px-2 text-right text-slate-600 font-mono text-[10px]">
												{session.universeId?.split("-")[0]}...
											</td>
