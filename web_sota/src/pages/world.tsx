...
function AssetPanel({ targetSlot }: { targetSlot: string | null }) {
	...
	return (
		<div className="space-y-4">
			...
			<button
				type="button"
				aria-label="Drop a 3D file here, or activate to browse files"
				...
				className={cn(
					"relative group p-4 border-2 border-dashed rounded-xl transition-all duration-300 text-center w-full",
					dragActive
			...
			>
				<span className="flex flex-col items-center gap-2">
					...
					<span className="px-3 py-1.5 rounded-lg bg-white/5 text-[9px] font-bold text-slate-300 uppercase tracking-tighter">
						Browse Files
					</span>
				</span>
			</button>
			<label className="sr-only" htmlFor="world-file-input">
				3D model file to inject
			</label>
			<input
				id="world-file-input"
				type="file"
