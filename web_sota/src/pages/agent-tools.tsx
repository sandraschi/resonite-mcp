...
export function AgentTools() {
	...
	const [stagingDir, setStagingDir] = useState(
		"D:/Temp/fleet_pipeline/resonite_fleet",
	);
	const [objectName, setObjectName] = useState("Cube");
	const [texturePath, setTexturePath] = useState(
		"D:/Temp/fleet_pipeline/textures/albedo.png",
	);
	...
	const [vrmDir, setVrmDir] = useState(
		"D:/Temp/fleet_pipeline/resonite_fleet/models",
	);
	...
	const [marbleDir, setMarbleDir] = useState(
		"D:/Temp/fleet_pipeline/resonite_marble",
	);
	const [fabDir, setFabDir] = useState(
		"D:/Temp/fleet_pipeline/inkscape_fab_art",
	);
			...
			<div className="flex items-start justify-between gap-4">
				<div>
					...
					<p className="text-sm text-slate-400 mt-1">
						Phase 1–6: fleet handoff, VRM, Marble worlds, voice macros, strict
						E2E.
					</p>
				</div>
				<button
					...
					<>
						...
						<div className="flex flex-wrap gap-2">
							<button
								...
								onClick={() =>
									run("resonite_fleet", { operation: "list_presets" })
								}
							>
								Fleet presets
							</button>
							<button
								...
								onClick={() =>
									run("resonite_fleet", { operation: "execution_mode" })
								}
							>
								Execution mode
							</button>
					...
					<>
						...
						{gallery.length === 0 ? (
							<p className="text-sm text-slate-500">
								No snapshots yet. Run list_staging first.
							</p>
						) : (
					...
					<>
						...
						<div className="flex flex-wrap gap-2">
							...
							<button
								...
								className="px-4 py-2 bg-slate-800 text-slate-200 rounded-md text-sm"
								onClick={() =>
									run("resonite_fleet", { operation: "inventory_status" })
								}
							>
								Inventory status
							</button>
					...
					<>
						...
						<div className="flex flex-wrap gap-2">
							<button
								...
								className="px-4 py-2 bg-slate-800 text-slate-200 rounded-md text-sm"
								onClick={() =>
									run("resonite_voice", { operation: "list_macros" })
								}
							>
								List macros
							</button>
							...
							<button
								...
								className="px-4 py-2 bg-slate-800 text-slate-200 rounded-md text-sm"
								onClick={() =>
									run("resonite_voice", { operation: "execution_mode" })
								}
							>
