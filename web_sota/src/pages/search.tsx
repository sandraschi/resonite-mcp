		...
		<div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
			<div className="max-w-2xl">
				...
				<p className="text-muted-foreground mt-2">
					Query the Resonite knowledge base using natural language. Powered by
					FastMCP 3.1 & LanceDB.
				</p>
			</div>
								...
								<CardContent>
									...
									<div className="mt-4 flex items-center justify-between text-[10px] font-bold uppercase tracking-wider">
										...
										<Button
											variant="ghost"
											size="sm"
											className="h-7 text-[10px] gap-1 hover:text-indigo-300"
										>
					...
					: !loading &&
						query && (
							<div className="text-center py-12 text-muted-foreground">
								<p className="italic">
									No direct matches found in current neural index.
								</p>
							</div>
						)}
			</div>
