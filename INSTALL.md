...
4. Start the server:
   ...
   uv run python -m resonite_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn resonite_mcp.server:app --port 10979
   ```
5. Open `http://localhost:10979` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/resonite-mcp/issues) |
